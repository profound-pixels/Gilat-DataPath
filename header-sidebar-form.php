...
<!--			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'ppx-starter' ); ?></button>-->
    ...
    <!--                                 SATCOM Menu here!-->
                            ...
                            <li>
                                 <a href="/maxview" class="uk-padding-small div-left uk-display-block header-bar header-bar-hover header-bar-short">
                                     <div class="uk-width-small">
                                         SOFTWARE
...
<!--
                        <li>
                            ...
                            <span class="uk-margin-small-right uk-text-warning uk-width-auto" uk-icon="icon: receiver"></span>
                            <span class="uk-padding-remove-left uk-margin-remove-top uk-width-expand">+1 678 597 0300</span>
                            </div>
                        </li>
-->
...
<!--
            <div class="uk-padding">
                <h2 class="header-bar">Message</h2>
                <p>Connect with a Datapath sales and support specialist now</p>
                <div>
                    <?php echo do_shortcode('[wpforms id="17045" title="false"]'); ?>
                </div>
            </div>
-->
